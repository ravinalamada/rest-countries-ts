...
const CountryDetails: React.FC = () => {
  ...
  const currencies = findCountry?.currencies.map((cur) => (
    <span key={cur.name}>{cur.name}</span>
  ))
  const borders = findCountry?.borders.map((border, i) => (
  ...
  return (
    <>
      ...
      <Container>
        <Frame>
          <Image src={findCountry?.flag} alt='image' />
        </Frame>
        <Wrapper>
          <Title>{findCountry?.name}</Title>
          <Text>
            <b>Native name:</b>
            <span>{findCountry?.nativeName}</span>
          </Text>
          <Text>
            <b>Population:</b>
          ...
          <Text>
            <b>Sub Region:</b>
            <span>{findCountry?.subregion}</span>
          </Text>
          <Text>
            <b>Capital:</b>
